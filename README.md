...
Now, as a Data Science Master's student at UC Irvine, I'm furthering my skills and embracing unique challenges. I love working from the ground up to solve problems efficiently, combining the creative magic and precise nature I've cultivated since childhood. My analytical mindset aligns well with sectors prioritizing decision-making, risk management, and pattern recognition.

As I progress towards my December 2024 graduation, I reflect on my journey. From the quiet child who loved writing and basketball to the tech enthusiast dreaming of the latest gadgets, each experience has shaped my approach to data science. This unconventional path has given me a unique perspective, blending creativity with **analytical rigor** and a passion for understanding complex systems. Looking to the future, I'm excited about the possibilities in data science. I see myself not just as a data scientist, but as an **innovator** who uses data to tell stories, solve problems, and make impactful decisions. My diverse background equips me with valuable insights for this field, and I'm eager to apply my blend of creativity and analytical thinking to continue driving innovation in data science.

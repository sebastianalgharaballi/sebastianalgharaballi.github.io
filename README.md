...
#### **MoodMe - Lead Machine Learning Engineer & Co-Founder (December 2023 - October 2024):**
...
#### **Plink.bio - Software Engineer, GenAI (October 2024 - February 2025):**

As a GenAI Software Engineer at Plink.bio, I architected and deployed AI-powered content analysis systems that transformed how creators understand and optimize their content strategy. I built a comprehensive multi-modal pipeline that automatically processes creator videos in under 3 seconds, combining computer vision, OCR, and speech-to-text to extract actionable insights from visual elements, text overlays, and audio transcripts. The system analyzes content across multiple languages and generates personalized strategy recommendations, **effectively replacing manual content analysis workflows that previously required hours of human review.** I developed real-time computer vision models achieving 90% accuracy in identifying monetizable product placement opportunities across 1000+ test frames, directly enabling creators to discover new revenue streams. Through seamless RESTful API integration with the existing platform infrastructure, I ensured sub-200ms response times while scaling the analysis capabilities across the entire user base. **This AI-driven approach empowered creators with data-driven content insights, leading to more strategic content creation and improved audience engagement metrics.**

**Tech Stack:** Python, Computer Vision, OCR, Speech-to-Text, LLMs, Multi-modal AI, RESTful APIs, Real-time Processing, PyTorch, OpenCV, Transformers, FastAPI, Docker, Cloud Infrastructure
...
<div align="center">
  ...
  <img src="r_img_1.png" alt="Description of image 2" width="250" style="display: inline-block; margin: 0 10px;">
</div>
